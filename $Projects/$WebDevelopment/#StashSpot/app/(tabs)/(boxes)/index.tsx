...
export default function BoxScreen() {
    const [boxes, setLocations] = useState<
    ...
    const renderItem = ({ item }) => (
        <View>
            <TouchableOpacity 
                ...
                onPress={() => navigation.navigate('boxes/[id]/boxIndex', { id: item.id })}>
                    <Text>{item.name}</Text>
            </TouchableOpacity>
                    ...
                    <View style={globalStyles.centeredView}>
                        <View style={globalStyles.modalView}>
                            ...
                            <Pressable
                                ...
                                onPress={() => {
                                    setModalVisible(!modalVisible);
                                    navigation.navigate('boxes/[id]/editLocation', { id: selectedItem.id })
                                }}
                            >
