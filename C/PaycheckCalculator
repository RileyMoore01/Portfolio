...
void computePaycheck(float rate, int time, float& grossPay, float& net)
{
	grossPay = time * rate;

	//I used (https://smartasset.com/taxes/paycheck-calculator#otFbRKhFTs) to check rates
	net = (time * rate) * .906;
}
