...
void setup() 
{
  ...
  images[4] = loadImage("icon_fox.png");
  //images[9] = loadImage("icon_cnn.png");
  //images[10] = loadImage("icon_onion.png");
  //images[11] = loadImage("icon_bbc.png");
  images[5] = loadImage("icon_weather.png");
  images[6] = loadImage("icon_clock.png");
  //images[14] = loadImage("icon_messages.png");
  images[7] = loadImage("icon_fingerprint.png");
  images[8] = loadImage("icon_steps.png");
  images[9] = loadImage("icon_weight.png");
  images[10] = loadImage("icon_sleep.png");

  //WIDGETS
  images[11] = loadImage("widget_weather.png");
  //images[20] = loadImage("widget_facebook.png");
  images[12] = loadImage("widget_reddit.png");
  //images[22] = loadImage("widget_twitter.png");
  //images[23] = loadImage("widget_tumblr.png");
  images[13] = loadImage("widget_FOX.png");
  ...
  buttons[5] = new Button(10, 5, btnWidth, btnHeight, images[5]);
  buttons[6] = new Button(1740, 30, btnWidth, btnHeight, "");
  clock = new Clock(1740, 30, btnWidth, btnHeight);
  //buttons[14] = new Button(1775, 850, btnWidth, btnHeight, images[14]);
  buttons[7] = new Button(900, 800, btnWidth, btnHeight, images[7]);
  buttons[8] = new Button(900, 800, btnWidth, btnHeight, "");
  buttons[9] = new Button(sideOffset + btnWidth*7, canvasHeight - (topOffset+2*btnHeight), btnWidth, btnHeight, "Yes");
  buttons[10] = new Button(sideOffset + btnWidth*9, canvasHeight - (topOffset+2*btnHeight), btnWidth, btnHeight, "No");
...
void draw() 
{
  ...
  if (buttons[7].toggled && !signed_in) {
    signed_in = true;
  }
